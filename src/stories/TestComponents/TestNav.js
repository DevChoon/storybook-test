...
import { onChangeNavigation } from "../BottomNavigations/BottomNavigationSlice";

export const TestNav = ({ display }) => {
  ...
  &.magazine {
    background-image: ${(props) =>
      props.selectNav === "magazine"
        ? `url("/public/assets/button_navigation_magazine_on.svg")`
        : `url("/public/assets/button_navigation_magazine_off.svg")`};
    background-repeat: no-repeat;
    background-position: center;
    background-size: 90px 56px;
  }
  &.more {
    background-image: ${(props) =>
      props.selectNav === "more"
        ? `url("/public/assets/button_navigation_more_on.svg")`
        : `url("/public/assets/button_navigation_more_off.svg")`};
    background-repeat: no-repeat;
    background-position: center;
    background-size: 90px 56px;
  }
